...
class EnhancedWolframAlphaTool(WolframAlphaTool):
    ...
    def __init__(self, app_id: str, cli_console=None, verbose=False):
        """Initialize.

        Args:
            app_id (str): Wolfram Alpha App ID.
            cli_console: Optional rich.console.Console for detailed output.
