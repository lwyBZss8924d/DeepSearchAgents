...
class EnhancedFinalAnswerTool(BaseFinaAnswerTool):
    ...
    def _append_sources_to_content(self, content: str, sources: List[str]) -> str:
        """
        Append sources in Markdown format to the content if they don't already exist.
        ...
        has_sources_section = "## Sources" in content and any(url in content for url in sources)
