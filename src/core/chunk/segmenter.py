#!/usr/bin/env python
# -*- coding: utf-8 -*-
# src/core/chunk/segmenter.py
# code style: PEP 8

"""
Jina AI Segmenter API for splitting text into smaller, more manageable chunks.
"""
...
class JinaAISegmenter:
    ...
    def __init__(
        ...
        Args:
            ...
            api_base_url (str):
                The URL of the Jina Segmenter API.
    ...
    def split_text(
        ...
        """
        Split text into chunks using Jina AI Segmenter API
        (synchronous version).
...
# Compatibility wrapper that implements the same interface
# as the original Chunker
class Chunker:
    """
