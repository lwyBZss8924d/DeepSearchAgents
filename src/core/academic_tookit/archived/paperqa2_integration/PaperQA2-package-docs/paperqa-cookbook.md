...
For development setup, please refer to the [CONTRIBUTING.md](contributing) file.
...
Inside [`paperqa/configs`](https://github.com/Future-House/paper-qa/blob/main/paperqa/configs/README.md) we bundle known useful settings:
...
This will limit your system to use the [tier1\_limits](https://github.com/Future-House/paper-qa/blob/main/paperqa/configs/tier1_limits.json), and slow down your queries to accommodate.
...
See detailed docs [about zotero, openreview and parsing](docs/tutorials/where_do_i_get_papers)
